                ...
                <div class="form_Wrapper">
                    ...
                    <form class="form_FormGroup">
                        ...
                        <div class="form_InputBox">
                            ...
                            <input type="password" class="input-item" name="password" placeholder="영문, 숫자, 특수문자 혼합 8-50자" minlength="8" maxlength="50" required="" value="">
                        </div>
                        <div class="form_InputBox">
                            <div class="input-label">
                            ...
                            <input type="password" class="input-item" name="passwordChecker" minlength="8" maxlength="50" required="" value="">
                        </div>
                        <div class="form_InputBox">
                            <div class="input-label">
                            ...
                            <input type="text" class="input-item" name="nickname" placeholder="2자 이상 15자 이하로 입력해 주세요." minlength="2" maxlength="15" required="" value="">
                        </div>
                        <div class="form_InputBox">
                            <div class="input-label">
