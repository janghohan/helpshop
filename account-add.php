                    ...
                    <form action="">
                        <div class="account-fields">
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-10">
                                  <input type="text" class="form-control" name="accountName" placeholder="거래처 or 소싱 업체">
                                </div>
                            </div>
                            <div class="mb-3 row">
                                <label for="staticEmail" class="col-sm-2 col-form-label">담당자</label>
                                <div class="col-sm-10">
                                  <input type="text" class="form-control" name="accountManager" placeholder="담당자 이름을 입력하세요.">
                                </div>
                            </div>
                            <div class="mb-3 row">
                                <label for="staticEmail" class="col-sm-2 col-form-label">담당자 연락처</label>
                                <div class="col-sm-10">
                                  <input type="text" class="form-control" name="ManagerContact"  placeholder="담당자 직통 연락처를 입력하세요.">
                                </div>
                            </div>
                            <div class="mb-3 row">
                                <label for="staticEmail" class="col-sm-2 col-form-label">대표번호</label>
                                <div class="col-sm-10">
                                  <input type="text" class="form-control" name="accountContact" placeholder="거래처 대표번호를 입력하세요.">
                                </div>
                            </div>
                            <div class="mb-3 row">
                                <label for="staticEmail" class="col-sm-2 col-form-label">주소</label>
                                <div class="col-sm-10">
                                  <input type="text" class="form-control" name="accountAddress" placeholder="주소를 입력하세요.">
                                </div>
                            </div>
                            <div class="mb-3 row">
                                <label for="staticEmail" class="col-sm-2 col-form-label">사이트</label>
                                <div class="col-sm-10">
                                  <input type="text" class="form-control" name="accountSite" placeholder="http://aaa.com">
                                </div>
                            </div>
                            <div class="mb-3 row">
                                <label for="staticEmail" class="col-sm-2 col-form-label">사업자번호</label>
                                <div class="col-sm-10">
                                  <input type="text" class="form-control" name="accountBNumber" placeholder="111-55-44444">
                                </div>
                            </div>
                            <div class="mb-3">
                                <label for="exampleFormControlTextarea1" class="form-label">메모</label>
                                <textarea class="form-control" name="accountMemo" rows="5"></textarea>
                            </div>
                        </div>
                    </form>
                </div>
